...
const state = {
  ...
  dialog: {
    add: COOKIE_DATA.dialog && COOKIE_DATA.dialog.add !== undefined ? COOKIE_DATA.dialog.add : constant.dialog.add,
    edit: COOKIE_DATA.dialog && COOKIE_DATA.dialog.edit !== undefined ? COOKIE_DATA.dialog.edit : constant.dialog.edit,
    import: COOKIE_DATA.dialog && COOKIE_DATA.dialog.import !== undefined ? COOKIE_DATA.dialog.import : constant.dialog.import
  },
  dense: {
...
const mutations = {
  ...
  SET_DIALOG: (state, value) => {
    state.dialog = { ...state.dialog, ...value }
